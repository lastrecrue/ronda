...
public class MatchBuilder {
	public static Match getMatch2Vs2Builder(Player player11, Player player12, Player player21, Player player22) {
	...
	public static Match getMatch1Vs1Builder(Player player11, Player player21) {
